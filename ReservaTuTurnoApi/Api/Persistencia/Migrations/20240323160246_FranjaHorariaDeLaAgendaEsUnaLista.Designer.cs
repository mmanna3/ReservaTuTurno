...
namespace Api.Migrations
{
    ...
    [Migration("20240323160246_FranjaHorariaDeLaAgendaEsUnaLista")]
    partial class FranjaHorariaDeLaAgendaEsUnaLista
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgendaServiciosDelProfesional", b =>
                {
                    ...
                    b.HasKey("AgendasId", "ServiciosId");
            ...
            modelBuilder.Entity("AgendaServiciosDelProfesional", b =>
                {
                    b.HasOne("Api.Core.Entidades.Agenda", null)
                        .WithMany()
                        .HasForeignKey("AgendasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Api.Core.Entidades.ServiciosDelProfesional", null)
                        .WithMany()

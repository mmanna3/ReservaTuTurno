...
function DiaCheckbox(props: IDiaCheckbox) {
  return (
    <div className="mb-[0.125rem] flex min-h-[1.5rem] flex-col">
      ...
      <input
        className="checked:focus:before:shadow-checkbox dark:checked:border-primary dark:checked:bg-primary me-[4px] mt-[0.15rem] size-5 appearance-none rounded-[0.25rem] border-[0.08rem] border-solid outline-none before:pointer-events-none before:absolute  before:opacity-0 before:shadow-transparent before:content-[''] checked:border-rosa checked:bg-rosa checked:before:opacity-[0.16] checked:after:absolute checked:after:-mt-[0.1px] checked:after:ms-[0.35rem] checked:after:block checked:after:h-[0.8125rem] checked:after:w-[0.375rem] checked:after:rotate-45 checked:after:border-[0.125rem] checked:after:border-l-0 checked:after:border-t-0 checked:after:border-solid checked:after:border-white checked:after:bg-transparent checked:after:content-[''] hover:cursor-pointer hover:before:opacity-[0.04] hover:before:shadow-black/60 focus:shadow-none focus:transition-[border-color_0.2s] focus:before:scale-100 focus:before:opacity-[0.12] focus:before:shadow-black/60 focus:before:transition-[box-shadow_0.2s,transform_0.2s] focus:after:absolute focus:after:z-[1] focus:after:block focus:after:h-[0.875rem] focus:after:w-[0.875rem] focus:after:rounded-[0.125rem] focus:after:content-[''] checked:focus:before:scale-100 checked:focus:before:transition-[box-shadow_0.2s,transform_0.2s] checked:focus:after:-mt-[0.1px] checked:focus:after:ms-[0.35rem] checked:focus:after:h-[0.8125rem] checked:focus:after:w-[0.375rem] checked:focus:after:rotate-45 checked:focus:after:rounded-none checked:focus:after:border-[0.125rem] checked:focus:after:border-l-0 checked:focus:after:border-t-0 checked:focus:after:border-solid checked:focus:after:border-white checked:focus:after:bg-transparent rtl:float-right dark:border-neutral-400"
        type="checkbox"
